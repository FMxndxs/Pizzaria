...
export function quoteFreight(
  ...
  if (!clientCoords) {
    return { distanceKm: null, withinRadius: false, freight: 0, mode: 'unknown', perKm, radiusKm, address }
  }
  ...
  return { distanceKm, withinRadius: false, freight: 0, mode: 'pickup_or_courier', perKm, radiusKm, address }
}
